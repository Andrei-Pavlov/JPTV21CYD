...
3. Основные библиотеки и технологии:<br/>
  3.1 MySQL2 в качестве базы данных<br/>
  3.2 Sequelize как ORM для работы с базой данных<br/>
  3.3 JWT (jsonwebtoken) для аутентификации<br/>
  3.4 Bcrypt для хеширования паролей<br/>
  3.5 Express Validator для валидации данных<br/>
  3.6 Multer для загрузки файлов<br/>
  3.7 CORS для обработки кросс-доменных запросов<br/>
  3.8 Dotenv для работы с переменными окружения<br/>
